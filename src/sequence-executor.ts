...
function setSolveStepsText() {
	previousStep.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="size-3 rotate-180 fill-black dark:fill-white" version="1.1" id="Layer_1" viewBox="0 0 512.003 512.003" xml:space="preserve">
            <g>
                <g>
	...
	if (sequenceIdx > 0) {
		previousStep.innerHTML += ` ${stringNotation(currentSequence[sequenceIdx - 1])}`
	}
	currentStep.innerHTML = stringNotation(currentSequence[sequenceIdx])
	nextStep.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="size-3 fill-black dark:fill-white" version="1.1" id="Layer_1" viewBox="0 0 512.003 512.003" xml:space="preserve">
            <g>
                <g>
                    <path d="M507.284,248.364L12.35,0.898C8.894-0.826,4.721-0.007,2.153,2.86c-2.56,2.884-2.867,7.125-0.759,10.351l159.07,242.79    L1.393,498.792c-2.108,3.226-1.801,7.467,0.759,10.351c1.664,1.86,4.002,2.859,6.383,2.859c1.289,0,2.594-0.29,3.814-0.896    l494.933-247.467c2.893-1.451,4.719-4.403,4.719-7.637S510.176,249.815,507.284,248.364z"/>
                </g>
